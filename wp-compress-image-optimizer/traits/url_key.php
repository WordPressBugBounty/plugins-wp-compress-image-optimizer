...
class wps_ic_url_key
{
    ...
    private function sanitize_title_with_dashes($title, $context = 'display')
    {
        ...
        if ('save' === $context) {
            ...
            $title = str_replace([
                ...
                '%e2%80%98', '%e2%80%99', '%e2%80%9c', '%e2%80%9d', '%e2%80%9a', '%e2%80%9b',
                '%e2%80%9e', '%e2%80%9f', '%e2%80%a2', '%c2%a9', '%c2%ae', '%c2%b0', '%e2%80%a6',
                '%e2%84%a2', '%c2%b4', '%cb%8a', '%cc%81', '%cd%81', '%cc%80', '%cc%84', '%cc%8c'
            ], '', $title);
    ...
    private function utf8_char_map()
    {
        return [
            ...
            'ß'=>'s', 'à'=>'a', 'á'=>'a', 'â'=>'a', 'ã'=>'a', 'ä'=>'a', 'å'=>'a', 'æ'=>'ae', 'ç'=>'c', 'è'=>'e',
