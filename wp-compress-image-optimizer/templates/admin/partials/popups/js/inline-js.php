            ...
            <div class="cdn-popup-top">
                <div class="inline-heading">
                    ...
                    <div class="inline-heading-text">
                        <h3><?php echo esc_html__('Inline JavaScript', WPS_IC_TEXTDOMAIN); ?></h3>
                ...
                <div class="cdn-popup-content-full">
                    <div class="cdn-popup-content-inner">
                        <textarea name="wpc-excludes[inline_js]" data-setting-name="wpc-inline"
                                  data-setting-subset="inline_js" class="exclude-list-textarea-value" placeholder="<?php echo esc_attr__('e.g. jquery-core-js', WPS_IC_TEXTDOMAIN); ?>"></textarea>
