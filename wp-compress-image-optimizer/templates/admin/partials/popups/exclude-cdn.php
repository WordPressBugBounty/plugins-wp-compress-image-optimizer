<div id="exclude-cdn-popup" style="display: none;">
            ...
            <div class="cdn-popup-top">
                <div class="inline-heading">
                    ...
                    <div class="inline-heading-text">
                        <h3><?php echo esc_html__('Exclude from CDN', WPS_IC_TEXTDOMAIN); ?></h3>
            ...
            <form method="post" class="wpc-save-popup-data" action="#">
                <div class="cdn-popup-content-full">
                    <div class="cdn-popup-content-inner">
                        <textarea name="wpc-excludes[cdn]" data-setting-name="wpc-excludes"
                                  data-setting-subset="cdn"  class="exclude-list-textarea-value"
