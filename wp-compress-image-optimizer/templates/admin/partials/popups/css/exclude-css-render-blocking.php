    ...
    <div class="cdn-popup-top">
      <div class="inline-heading">
        ...
        <div class="inline-heading-text">
          <h3><?php echo esc_html__('Exclude from CSS Render Blocking', WPS_IC_TEXTDOMAIN); ?></h3>
    ...
    <form method="post" class="wpc-save-popup-data" action="#">
      <div class="cdn-popup-content-full">
        <div class="cdn-popup-content-inner">
          <textarea name="wpc-excludes[css_render_blocking]" data-setting-name="wpc-excludes" data-setting-subset="css_render_blocking" class="exclude-list-textarea-value" placeholder="<?php echo esc_attr__('e.g. plugin-name/js/script.js, scripts.js, anyimage.jpg', WPS_IC_TEXTDOMAIN); ?>"></textarea>
