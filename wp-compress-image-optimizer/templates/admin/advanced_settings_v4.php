                              ...
                              if (!$showAdvanced) {
                                ?>
                                  ...
                                  echo admin_url('options-general.php?page=' . $wps_ic::$slug . '&showAdvanced=true'); ?>"
                                    ...
                                    echo WPS_IC_ASSETS; ?>/v4/images/popups/selectMode/advanced-settings.svg" title="Advanced Settings"/> Advanced Settings</a>
                                <?php
                              } else { ?>
                                  <a href="<?php
                                  echo admin_url('options-general.php?page=' . $wps_ic::$slug . '&showAdvanced=false'); ?>" class="wpc-plain-btn"><img src="<?php
                                    echo WPS_IC_ASSETS; ?>/v4/images/popups/selectMode/advanced-settings.svg" title="Advanced Settings"/> Simple Settings</a>
                                <?php
                              } ?>

                                <div class="wpc-optimization-page-button">
                                    <a class="wpc-optimizer-running wpc-page-optimizations-running wpc-stop-page-optimizations" style="display:none">
                                        <i class="icon-pause"></i> Pause Optimization</a>
                                    <a class="btn btn-gradient text-white fw-500 btn-radius wpc-optimizer-running wpc-page-optimizations-running" style="display:none;font-weight: bold;font-family:'proxima_semibold' !important;">
                                        <img src="<?php
                                        echo WPS_IC_ASSETS; ?>/v4/images/loading-icon-media.svg" style="max-height: 25px;margin-right:10px">
                                        Optimization in progress...
                                    </a>
                                    <a class="btn btn-gradient text-white fw-500 btn-radius wpc-start-optimizations" style="display:none;font-weight: bold;font-family:'proxima_semibold' !important;">
                                        <img src="<?php
                                    ...
                                    wpc-optimization-complete" style="display:none;font-weight: bold;font-family:'proxima_semibold' !important;">
                                        Site Optimized
                                    </a>
                                    <a class="btn btn-gradient text-white fw-500 btn-radius
                                    wpc-preparing-optimization" style="display:none;font-weight: bold;font-family:'proxima_semibold' !important;">
                                        Preparing...
                                    </a>
                                    <a class="btn btn-gradient text-white fw-500 btn-radius
                                  ...
                                  <ul>
                                      <li>
                                        ...
                                        if ($localOptimizationStatus == 'compressing') { ?>
                                            <a href="<?php
                                            echo admin_url('options-general.php?page=' . $wps_ic::$slug . '&view=bulk&hash=' . time()); ?>" class="wps-ic-stop-bulk-compress" style="display:block;"><i class="icon-pause"></i> Pause Local Optimization</a>
                                          <?php
                                        } ?>
                                      </li>
                                      <li>
                                        ...
                                        if ($localOptimizationStatus == 'restoring') { ?>
                                            <a href="<?php
                                            echo admin_url('options-general.php?page=' . $wps_ic::$slug . '&view=bulk&hash=' . time()); ?>" class="wps-ic-stop-bulk-restore" style="display:block;"><i class="icon-pause"></i> Pause Local Restore</a>
                                          <?php
                                        } ?>
                                      </li>
                                  </ul>
                            ...
                            <div class="wpc-settings-tab-content-inner">
                                    ...
                                    <div class="wpc-tab-content-box" id="other-optimization">
                                      ...
                                      echo $gui::checkboxTabTitle('Other Optimizations', 'Advanced tweaks to help for specific use cases, use only as needed.', 'other-optimization/tab-icon.svg', ''); ?>
                                        ...
                                        <div class="wpc-items-list-row mb-20">
                                          ...
                                          <?php
                                          echo $gui::checkboxDescription_v4('Preload critical fonts', 'Preload fonts from generated critical CSS', false,
                                            false, 'preload-crit-fonts', false, 'right',
                                            false, false, ''); ?>
                                ...
                                <div class="wpc-tab-content" id="smart-optimization" style="display:none;">
                                    ...
                                    <div class="wpc-tab-content-box">
                                          ...
                                          <div class="wpc-optimization-status" style="display:flex;align-items:center;border:none;">
                                              ...
                                              <div class="d-flex align-items-top gap-3 tab-title-checkbox" style="width:100%; padding-right:20px">
                                                  <div class="wpc-checkbox-icon">
                                                      ...
                                                      echo WPS_IC_URI . '/assets/v4/images/24monitor.svg' ?>);min-height:100px;min-width:100px;background-repeat:no-repeat;" class="background-image wpc-smart-monitor-img">
                                                      </div>
                                                  ...
                                                  <div class="wpc-checkbox-description" style="z-index:2">
                                                      ...
                                                      <h4 class="fs-500 text-dark-300 fw-500 p-inline wpc-smart-optimization-title">Smart Optimization + Performance</h4>
                                                          <img src="<?php
                                                          echo WPS_IC_URI . '/assets/v4/images/24bubble.svg' ?>" style="padding-left: 15px;height: 30px;padding-top: 2px;">
                                                      </div>
                                                      <p class="wpc-smart-optimization-text" style="margin: 7px 0px 4px">No need to lift a finger, your website is intelligently optimized around the clock based on demand.</p>
...
-->
                                              <div class="wpc-optimization-status" style="display:flex;align-items:center;margin-left:10px;padding-left:20px">
                                                  <div class="optimization-image">
                                                      <img src="<?php
                                                      echo WPS_IC_URI . '/assets/v4/images/pages_optimized.svg' ?>" alt="" style="margin-top:-5px">
                                                  </div>
