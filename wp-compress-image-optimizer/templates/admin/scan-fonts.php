...
<div class="wpc-tab-content-box wpc-card-rows wpc-perf-section" id="font-scan">
    ...
    <div class="wpc-font-scan-form">
        <div class="wpc-scan-input-group">
            <input type="text" name="scanUrl" id="wpc-scan-url" value="<?php echo esc_url(get_option('wpc_remote_site_url') ?: site_url()); ?>" placeholder="<?php echo esc_attr__('https://yoursite.com/page-to-scan', WPS_IC_TEXTDOMAIN); ?>" />
