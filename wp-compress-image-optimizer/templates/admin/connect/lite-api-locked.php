                    ...
                    <div class="wps-lite-connect-left">
                        ...
                        <div class="wpc-connect-illustration">
                            ...
                            <div class="wpc-connect-illus-text">
                                <h3><?php echo esc_html__('Unlock Full Power', WPS_IC_TEXTDOMAIN); ?></h3>
                                <p><?php echo esc_html__('Premium optimization, global CDN, and advanced configuration await.', WPS_IC_TEXTDOMAIN); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="wps-lite-connect-right">
                        ...
                        <div class="wps-lite-form-container">
                            <div class="wpc-connect-header">
                                <h2><?php echo esc_html__('Unlock Features', WPS_IC_TEXTDOMAIN); ?></h2>
