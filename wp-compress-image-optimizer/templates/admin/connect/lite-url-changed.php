                    ...
                    <div class="wps-lite-connect-right">
                        ...
                        <div class="wps-lite-form-container">
                            ...
                            <ul class="wpc-inline-feature-list">
                                <li class="wpc-inline-fl-icon"><img src="<?php echo WPS_IC_URI; ?>/assets/v4/images/warning.svg" alt="Lite Check"/></li>
                                <li class="wpc-inline-fl-text">Looks like your site URL has changed, please reconnect with a new apikey.</li>
                            </ul>
