...
?>
<form method="POST" action="#" class="wpc-ic-mu-bulk-settting-reconfigure-form">

  <input type="hidden" name="apply_to_sites" value="0"/>
    ...
    <div class="wpc-ic-mu-site-header">
      <div class="wpc-ic-mu-site-left-side">
        <div class="wpc-ic-mu-site-name">
          ...
          <h3><?php echo 'Overwrite Settings'; ?></h3>
          <h5><?php echo 'Changes will apply to all selected sites'; ?></h5>
        </div>
      </div>
      <div class="wpc-ic-mu-site-right-side">
        <input type="submit" name="Connect" value="Apply & Connect" class="wpc-mu-bulk-reconfigure"/>
      </div>
    </div>
                      ...
                      <div class="wpc-settings-tab-content-inner">
                          <div class="wpc-tab-content-box">
                              ...
                              <div class="wpc-items-list-row mb-20">
                                  ...
                                  <?php echo $gui::checkboxDescription_v4('Resize by Incoming Device', 'Serve the ideal image based on the visitors device to slash file-sizes, improve load times and offer a better experience.', false, '0', 'generate_adaptive', false, 'right', false); ?>

                                  <?php echo $gui::checkboxDescription_v4('Serve WebP Images', 'Generate and serve next generation WebP images to supported browsers and devices.', false, '0', 'generate_webp', false, 'right', false); ?>
                              ...
                              <div class="wpc-items-list-row mb-20">
                                  ...
                                  <?php echo $gui::checkboxDescription_v4('Lazy Loading by Viewport', 'Load additional images as the user scrolls to save tons of bandwidth and slash overall page size.', false, '0', 'lazy', false, 'right', false); ?>
