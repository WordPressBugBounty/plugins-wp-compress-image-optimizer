...
?>
<form method="POST" action="#" class="wpc-ic-mu-bulk-settting-form">
  ...
  <div class="wpc-ic-mu-site-container ic-advanced-settings-v2">
    <div class="wpc-ic-mu-site-header">
      ...
      <div class="wpc-ic-mu-site-right-side">
        <input type="submit" name="Connect" value="Apply & Connect" class="wpc-mu-bulk-connect"/>
      </div>
    </div>
