...
* Fixed Elementor Loop Grid
* CDN Fallbacks Improved
* Faster First Render

= 7.24.00 =
* Faster Page Caching
* Critical CSS Improvements
* Smart Delivery for Assets
* Improved LCP
...
* Elementor & Gallery Compatibility Patches
* Bug Fixes
...
* Improvements to RUM Dashboard
* Fixes to Aspect Ratio Settings

= 7.20.01 =
* Added auto mode
* Added real-world performance monitoring
* Improved CSS & JavaScript optimizations
* Improved compatibility, stability and resource usage

= 7.10.09 =
* Critical CSS reliability improvements
* Cache improvements and compatibility
* CSS Delivery fixes
* Integration updates

= 7.10.04 =
* Security Improvement
* Fixed missing backgrounds/styles on some themes (e.g. Sonaar/Iron) that load CSS via the page URL.
* More reliable images on older phones & browsers (old Safari/Android) — fixed a script error that could stop images loading.
* Plays nicely with other cache plugins — no longer takes over the page-cache file when WP Compress caching is turned off.
* Bug fixes & stability: Bunny Fonts, critical-CSS timing, bulk cleanup, and minor PHP warnings.

= 7.10.03 =
* Smart Delivery Improvements
...
= 7.00.08 =
* Malformed SrcSet Patch
* LCP SrcSet Improved
* Complianz Integration

= 7.00.07 =
* Critical CSS Font Preload Patch
* UI Tweaks
* CloudWays Patch

= 7.00.06 =
* Fixed CDN Image Quality Parameter
* Added Compatibility for Cache on Hosting Providers
* WP Engine Compatibility
* Additional Delay JS Excludes

= 7.00.04 =
* UI Updates
* Sample Data for Charts Updated

= 7.00.03 =
* Local Image Optimization Patch
* Fixed & Improved UI
* Auto-Optimize on Upload Patch
* Introduced Brand Variables for WhiteLabel
...
= 6.60.44 =
* Patch for Search & Replace in JSON

= 6.60.43 =
* Critical CSS Patch

= 6.60.42 =
* PageSpeed URL Update

= 6.60.41 =
* Added MetForm DelayJS Exclude
* RevSlider Image Size Patch
* Woo Variations Patch
* Purging Logic Improved
* Fixed Fonts Replace
* Improved LazyFontAwesome

= 6.60.40 =
* Critical CSS Improvements

= 6.60.39 =
* Font Optimization Improvements
* PageSpeed UI Patch
...
= 6.60.37 =
* Integration for Slider Revolution 7
* iFrame Delay Patch
* Purge Cache on Critical Update
* UI Patch
...
= 6.50.56 =
* Patch for Critical CSS Purge
* Improvement of Mobile Page Optimizations
* Replace in Picture Tags Fix

= 6.50.55 =
* Added Purge All for Elementor
* Force HTTPS for Critical CSS Combined
* Optimize Metadata on Images Added
* Added Spectra Purge Hooks
* Added Min Mobile Image Width Setting
* GTag Delay Patch
* Fix for Integration Purging
* Improved UI
...
* WhiteLabel UI Patches
* CF Purging Patch
* Smart Optimization Page UI Improvements
* Optimizer Improvements
* iFrame Delay Bug Fix
* Super Page Cache Integration
* Local Image Optimization Improvements
* Local Lazy Fix
* CDN Partially Off Fix
* Cache Cookie Settings

= 6.50.49 =
* Patch for Critical CSS Calls
* Patch for Admin UI

= 6.50.48 =
* Minor UI Patch for GPS Tests

= 6.50.47 =
* Patch for Critical CSS

= 6.50.46 =
* Patch for Initial GPS Test
