jQuery(document).ready(function ($) {
    ...
    $("#optimizationTable").on("click", ".per-page-settings-cog", function (e) {
        ...
        WPCSwal.fire({
            ...
            customClass: {container: "no-padding-popup-bottom-bg switch-legacy-popup"},
            onOpen: function () {
    ...
    $(".wpc-pull-stats").on("click", function (e) {
        ...
        $.post(ajaxurl, {action: "wps_ic_pull_stats"}, function (response) {
            $(button).html(state)
        });
        return false
    });
  ...
  <script>
    ...
    $("#optimizationTable").on("click", ".wpc-run-test", function (e) {
        ...
        if (optimize === 1) {
            $.ajax({
                ...
                success: function (response) {
                    updateOptimizationStatus();
                    optimizationCheckInterval = setInterval(updateOptimizationStatus, 5e3)
                },
    ...
    function updateMessageCycle(response) {
        ...
        var timeout = local === true ? 2e3 : 2e3;
    ...
    function formatTime(timeInMs) {
        if (timeInMs < 1e3) {
            ...
            let timeInSeconds = (timeInMs / 1e3).toFixed(1);
